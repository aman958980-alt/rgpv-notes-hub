    ...
    <main className="min-h-screen bg-slate-100 dark:bg-slate-900 text-black dark:text-white p-10">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow flex justify-between">
          ...
          <a
            href="/pdf/bt102/Unit1_Handwritten_Notes.pdf"
            download
        ...
        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow flex justify-between">
          ...
          <a
            href="/pdf/bt102/Unit2_Handwritten_Notes.pdf"
            download
            className="bg-blue-700 text-white px-4 py-2 rounded"
          >
            📥 Download
        ...
        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow flex justify-between">
          ...
          <a
            href="/pdf/bt102/Unit3_Handwritten_Notes.pdf"
            download
            className="bg-blue-700 text-white px-4 py-2 rounded"
          >
            📥 Download
        ...
        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow flex justify-between">
          ...
          <a
            href="/pdf/bt102/Unit4_Handwritten_Notes.pdf"
            download
            className="bg-blue-700 text-white px-4 py-2 rounded"
          >
            📥 Download
        ...
        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow flex justify-between">
          ...
          <a
            href="/pdf/bt102/Unit5_Handwritten_Notes.pdf"
            download
            className="bg-blue-700 text-white px-4 py-2 rounded"
          >
            📥 Download
